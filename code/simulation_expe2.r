...
f_exp1 <- function(seed){
  ...
  parm.tmp$beta$beta13 = c(0, 0, c(-0.1,-0.1,0.1,0.1), rep(0,6), -0.33, -0.33)  # 
  parm.tmp$beta$beta23 = c(0, 0, c(-0.1,-0.1,0.1,0.1), rep(0,6), -0.33, -0.33)  # 
  ...
  dat_save_path = paste0(".../expe_log_fixed_part/data_seed_",seed,".csv")
  ...
  save_path = paste0(".../expe_log_fixed_part/seed_",seed,".rds")
...
my_new_folder = ".../expe_log_fixed_part"
...
folder_path = ".../expe_log_fixed_part"
...
df_save_path = ".../expe_log_fixed_part.csv"
