...
f_exp1 <- function(seed){
  ...
  dat_save_path = paste0(".../expe_log_all_varied1000/data_seed_",seed,".csv")
  ...
  save_path = paste0(".../expe_log_all_varied1000/seed_",seed,".rds")
...
my_new_folder = ".../expe_log_all_varied1000"
...
folder_path = ".../expe_log_all_varied1000"
...
df_save_path = ".../expe_log_all_varied1000.csv"
