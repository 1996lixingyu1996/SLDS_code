...
f_exp1 <- function(seed){
  ...
  dat_save_path = paste0(".../expe_log_fixed_all/data_seed_",seed,".csv")
  ...
  save_path = paste0(".../expe_log_fixed_all/seed_",seed,".rds")
...
my_new_folder = ".../expe_log_fixed_all"
...
folder_path = ".../expe_log_fixed_all"
...
df_save_path = ".../expe_log_fixed_all.csv"
